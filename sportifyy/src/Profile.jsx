        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "30px" }}>
                ...
                <p style={{ color: "#dbeafe", marginTop: "4px", fontWeight: 500 }}>
                    ...
                    Level {user.level || 1} - {(user.favoriteSport || "BASKETBALL")?.toUpperCase()} Fan
                    {/* ========== END OF CHANGES ========== */}
                </p>
            ...
            <div style={{
                ...
                <div style={{ textAlign: "center" }}>
                    {/* ========== CHANGED: Added default value ========== */}
                    <h3 style={{ fontSize: "18px", color: "#fff", fontWeight: "700" }}>{user.badges || 0}</h3>
                    {/* ========== END OF CHANGES ========== */}
